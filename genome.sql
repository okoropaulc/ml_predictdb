...
--
-- Table structure for table `gene_models`
--

CREATE TABLE `gene_models` (
  `gene_id` varchar(15) NOT NULL,
  `population_id` varchar(15) NOT NULL,
  `algorithm_id` varchar(5) NOT NULL,
...
--
-- Indexes for table `gene_models`
--
ALTER TABLE `gene_models`
...
--
-- Constraints for table `gene_models`
--
ALTER TABLE `gene_models`
  ADD CONSTRAINT `gene_models_ibfk_1` FOREIGN KEY (`gene_id`) REFERENCES `gene` (`gene_id`),
  ADD CONSTRAINT `gene_models_ibfk_2` FOREIGN KEY (`algorithm_id`) REFERENCES `algorithm` (`algorithm_id`),
  ADD CONSTRAINT `gene_models_ibfk_3` FOREIGN KEY (`population_id`) REFERENCES `population` (`population_id`);
...
--
ALTER TABLE `knn_model`
  ADD CONSTRAINT `knn_model_ibfk_1` FOREIGN KEY (`gene_id`) REFERENCES `gene_models` (`gene_id`),
  ADD CONSTRAINT `knn_model_ibfk_2` FOREIGN KEY (`population_id`) REFERENCES `gene_models` (`population_id`);
...
ALTER TABLE `prediction_result`
  ...
  ADD CONSTRAINT `prediction_result_ibfk_4` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
...
--
ALTER TABLE `rf_model`
  ADD CONSTRAINT `rf_model_ibfk_1` FOREIGN KEY (`gene_id`) REFERENCES `gene_models` (`gene_id`),
  ADD CONSTRAINT `rf_model_ibfk_2` FOREIGN KEY (`population_id`) REFERENCES `gene_models` (`population_id`);

--
-- Constraints for table `svr_model`
--
ALTER TABLE `svr_model`
  ADD CONSTRAINT `svr_model_ibfk_1` FOREIGN KEY (`gene_id`) REFERENCES `gene_models` (`gene_id`),
  ADD CONSTRAINT `svr_model_ibfk_2` FOREIGN KEY (`population_id`) REFERENCES `gene_models` (`population_id`);
COMMIT;
