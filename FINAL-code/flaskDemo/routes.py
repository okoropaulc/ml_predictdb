...
from flaskDemo.forms import UploadGene, Add_Gene_Model, SVRDelete, RFDelete, KNNDelete, KNN, RF, SVR, RegistrationForm, LoginForm, GeneModelForm, GeneForm, UserDeleteForm
